...
Created a clean 5-page structure:
...
- Minimal, obvious navigation (5 top-level links)
...
- `data/media.json` - Media/photo data
- `js/media.js` - Media gallery renderer
...
- Media gallery styles (`.media-item`, `.media-location`)
...
1. **Place photo in `assets/images/`**
